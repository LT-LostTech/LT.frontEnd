...
export function HeroSection() {
    return (
        <HeroSectionContainer>
            ...
            <Button width="660px" height="84px" colorText={theme.colors.black} bgColor={theme.colors.white} border="transparent" fontWeight="600" text="Começe agora!" onClick={() => window.scrollTo(0,1000)}/>
        </HeroSectionContainer>
